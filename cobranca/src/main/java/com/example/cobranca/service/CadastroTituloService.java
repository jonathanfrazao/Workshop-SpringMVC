...
import com.example.cobranca.repository.filter.TituloFilter;
...
public class CadastroTituloService {
	...
	public void salvar(Titulo titulo) {
		try {
			...
			throw new IllegalArgumentException("formato de data invádido");
		}
	}
	...
	public List<Titulo> buscar(TituloFilter filtro) {
